  ...
  return (
    ...
    <section className='px-4 md:px-0 md:max-w-[94.4%] w-full mx-auto flex flex-col text-[#4A3419]'>
      ...
      <form action="" className='w-full flex flex-col'>
        ...
        <fieldset className='flex items-center space-x-5 justify-between w-full border-2 vw:border-[.104vw] border-[rgba(245,_245,_245,_0.2)] py-3 vw:py-[.625vw] px-4 lg:pl-6 vw:pl-[1.25vw] lg:pr-[14px] vw:pr-[.729vw] md:max-w-[517px] vw:max-w-[26.9270vw] md:mx-auto'>
