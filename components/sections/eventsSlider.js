  ...
  return (
    ...
    <section className="pl-4 md:pl-5 lg:pl-[2.777%] w-full flex flex-col pb-[74px] md:pb-[56px] vw:pb-[2.91666vw] relative">
      ...
      <div className="absolute pl-[3.33%] bottom-0 left-0 flex items-center space-x-4 vw:space-x-[.83333vw]">
        ...
        <div className="left-arrow cursor-pointer w-[11px] vw:w-[.5729vw]" role='button' tabIndex={0}>
          <Image
            src="/images/prev.svg"
            alt="Next"
            width={11}
        ...
        <div className="right-arrow cursor-pointer w-[11px] vw:w-[.5729vw]" role='button' tabIndex={0}>
          <Image
            src="/images/next.svg"
            alt="Next"
            width={11}
